...
song_table_create = ("""CREATE TABLE IF NOT EXISTS songs(song_id VARCHAR(20) PRIMARY KEY,
title VARCHAR(100),
...
artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists (artist_id VARCHAR(20) PRIMARY KEY,
name VARCHAR(100),
...
songplay_table_insert = ("""INSERT INTO songplays (start_time, user_id, level, songplay_id, artist_id, session_id, location, user_agent)
